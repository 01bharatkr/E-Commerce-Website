...
import profilePic from "./profile-bharat.jpg";
        ...
        >
            ...
            <div className="flex flex-row justify-between items-center h-16">
              <Typography variant="h6">
                <span className="text-blue-500 hover:underline text-base md:text-lg">
                  <a href="https://github.com/01bharatkr/E-Commerce-Website">
                    𝐀𝐩𝐩 𝐑𝐞𝐚𝐝𝐦𝐞
                  </a>
                </span>
              </Typography>
              ...
              <IconButton>
                <a
                  href="https://github.com/01bharatkr"
                  target="_blank"
          ...
          <DialogContent dividers>
            ...
            >
              ...
              >
                ⚡ 𝐈'𝐦 𝐚 𝐏𝐚𝐬𝐬𝐢𝐨𝐧𝐚𝐭𝐞 𝐅𝐫𝐨𝐧𝐭𝐞𝐧𝐝 𝐑𝐞𝐚𝐜𝐭 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐰𝐢𝐭𝐡 5+ 𝐩𝐫𝐨𝐣𝐞𝐜𝐭𝐬.
              </Typography>
              <Typography
                variant={isMobile ? "body2" : "body1"}
                textAlign="center"
              ...
              <ul className="flex flex-col gap-2   ml-3 md:ml-6 mb-4 text-sm md:text-base text-gray-800 list-none">
                <li>
                  ✅ 𝑺𝒆𝒂𝒎𝒍𝒆𝒔𝒔 𝒎𝒖𝒍𝒕𝒊-𝒍𝒂𝒏𝒈𝒖𝒂𝒈𝒆 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 (𝑬𝒏𝒈𝒍𝒊𝒔𝒉 & Hindi).
                </li>
                <li>
